...
export const BUILT_IN_TEMPLATES: DocumentTemplateDef[] = [
  ...
  // ── PRAWO BUDOWLANE ──
  {
    ...
    fields: [
      { key: 'data_zawarcia', label: 'Date zawarcia', type: 'date', required: true },
      { key: 'miejscowosc', label: 'Miejscowość', type: 'text', required: true },
      { key: 'imie_nazwisko_inwestora', label: 'Inwestor (name/nazwa)', type: 'text', required: true },
  ...
  // ── PRAWA AUTORSKIE ──
  {
    ...
    fields: [
      { key: 'data_zawarcia', label: 'Date zawarcia', type: 'date', required: true },
      { key: 'miejscowosc', label: 'Miejscowość', type: 'text', required: true },
      { key: 'imie_nazwisko_tworcy', label: 'Twórca (name i nazwisko)', type: 'text', required: true },
      ...
      { key: 'tytul_dziela', label: 'Title dzieła', type: 'text', required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'tytul_utworu', label: 'Title utworu', type: 'text', required: true },
  ...
  // ── DOKUMENTY ADMINISTRACYJNE ──
  {
    ...
    fields: [
      ...
      { key: 'imie_nazwisko_nadawcy', label: 'Nadawca (name i nazwisko)', type: 'text', required: true },
